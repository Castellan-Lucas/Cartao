  ...
  return (
    <div className="container-obrigado">
      <div className="conteudo-content">
        ...
        <h4>
          {" "}
          Suas informações foram salvas em nosso banco de dados! Posteriormente
          forneceremos a opção para utiliza-la quando necessaria
        </h4>
      </div>
    </div>
  );
